...
public class OrderService {
  ...
  /**
   * BUY-only execution rule: - execute when currentPrice <= priceLimit - need enough USD: cost =
   * currentPrice * amountBtc - mark order FILLED exactly once
   */
    ...
    var claimed =
        orderRepository
            ...
            .orElseThrow(
                () ->
                    new DomainException(
                        ORDER_NOT_FOUND, ORDER_NOT_FOUND_TEXT + ": " + orderId.value()));
